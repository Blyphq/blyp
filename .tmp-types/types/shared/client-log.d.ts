export type ClientLogLevel = 'debug' | 'info' | 'warning' | 'error' | 'critical' | 'success' | 'table';
...
export type RemoteDeliveryFailureReason = 'offline' | 'network_error' | 'response_status' | 'invalid_endpoint' | 'missing_transport' | 'queue_overflow';
