...
export type ParseableErrorPayload = BlypErrorLike | Error | string | Record<string, unknown> | null | undefined;
...
export type CreateCodeFunction = (definition: BlypErrorCodeDefinition, overrides?: BlypErrorCodeCreateOptions) => BlypErrorLike;
